...
class paging_mahasiswa{
	...
	function cariPosisi($batas){
		...
		if($halaman_aktif > 1){
			...
			$link_halaman .= "
			<li class='page-item'><a class='page-link' href=index.php?page=read&home>First</a></li>
			<li class='page-item'><a class='page-link' href=index.php?page=read&home=$prev> Prev</a></li>  ";
		}
		else{
		...
		for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
		  if ($i < 1)
		  	continue;
			  $angka .= "<li class='page-item'><a class='page-link' href=index.php?page=read&home=$i>$i</a></li>  ";
		  }
		...
		for($i=$halaman_aktif+1; $i<($halaman_aktif+3); $i++){
			...
			if($halaman_aktif < $jmlhalaman){
				...
				$link_halaman .= "
				<li class='page-item'><a class='page-link' href=index.php?page=read&home=$next>Next</a></li>
				<li class='page-item'><a class='page-link' href=index.php?page=read&home=$jmlhalaman>Last </a><li>";
			}
			else{
				$prev = $halaman_aktif-1;
				$link_halaman .= " <li class='page-item'><a class='page-link' href='index.php?page=read&home=$next' aria-label='Next'> Next</a></li> ";
			}
				return $link_halaman;
		}
}
